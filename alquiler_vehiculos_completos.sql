...
CREATE TABLE parentescos (
    id INT PRIMARY KEY AUTO_INCREMENT,
    parentesco TEXT UNIQUE NOT NULL,
    usuario_registro_id INT NOT NULL,
    fecha_hora_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    usuario_actualizo_id INT NOT NULL,
    fecha_hora_actualizo TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE propietarios (
    ...
    documento_buena_conducta_path TEXT DEFAULT NULL,
    cedula TEXT UNIQUE,
    cedula_path TEXT DEFAULT NULL,
    licencia TEXT UNIQUE,
    licencia_path TEXT DEFAULT NULL,
    direccion TEXT,
    telefono TEXT,
    email TEXT,
    usuario_registro_id INT NOT NULL,
...
CREATE TABLE garantes_inquilinos (
    ...
    email TEXT,
    parentesco_id INT NOT NULL,
    documento_referencia_laboral_path TEXT DEFAULT NULL,
    usuario_registro_id INT NOT NULL,
    fecha_hora_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    usuario_actualizo_id INT NOT NULL,
    fecha_hora_actualizo TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE vehiculos (
    ...
    color TEXT,
    descripcion TEXT,
    precio_semanal TEXT NOT NULL,
    condiciones TEXT,
    disponible TEXT DEFAULT '1',
    usuario_registro_id INT NOT NULL,
    fecha_hora_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    usuario_actualizo_id INT NOT NULL,
    fecha_hora_actualizo TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE historico_propietarios (
    ...
    documento_buena_conducta_path TEXT,
    cedula TEXT,
    cedula_path TEXT,
    licencia TEXT,
    licencia_path TEXT,
...
CREATE TABLE historico_garantes_inquilinos (
    ...
    email TEXT,
    parentesco_id INT,
    documento_referencia_laboral_path TEXT,
    usuario_registro_id INT,
    fecha_hora_registro TIMESTAMP,
    usuario_actualizo_id INT,
    fecha_hora_actualizo TIMESTAMP
...
ALTER TABLE propietarios
    MODIFY COLUMN cedula TEXT,
    MODIFY COLUMN licencia TEXT;
